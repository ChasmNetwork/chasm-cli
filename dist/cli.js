...
import { checkDockerInstallation, installDocker, isContainerNameInUse, removeDockerContainer, setupDocker, } from './utils/docker/index.js';
...
import ora from 'ora';
import { getPublicIPAddress, isPortInUse, stopProcessOnPort, } from './utils/network.js';
...
const setupEnvFile = async (scoutUID, webhookApiKey) => {
...
const setupScout = async () => {
    try {
        ...
        spinner.succeed(chalk.green('Wallet connected: ') + chalk.blue(selectedWallet));
        spinner.start('Logging in...');
        console.log(chalk.yellow(`Please sign login message on your wallet...`));
